...
CREATE TABLE "personal_information" (
    ...
    "id_province" VARCHAR(36) NOT NULL,
    "id_city" VARCHAR(36) NOT NULL,
    "id_district" VARCHAR(36) NOT NULL,
    "id_postal_code" VARCHAR(36) NOT NULL,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "personal_information" ADD CONSTRAINT "personal_information_id_province_fkey" FOREIGN KEY ("id_province") REFERENCES "master_province"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "personal_information" ADD CONSTRAINT "personal_information_id_city_fkey" FOREIGN KEY ("id_city") REFERENCES "master_city"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "personal_information" ADD CONSTRAINT "personal_information_id_district_fkey" FOREIGN KEY ("id_district") REFERENCES "master_district"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
