import { createMasterCategorySocialLink, getListMasterCategorySocialLink } from "@2. controllers/0.3 master-category-social-link/0. master-category-social-link";
