...
export const getListEducationService = async (params: TParamsListEducationDto) => {
  ...
  const orderBy: Prisma.EducationOrderByWithRelationInput | undefined =
    sort_by ? relationOrderMap[sort_by as string] || { [sort_by as keyof Prisma.EducationOrderByWithRelationInput]: sort_dir } : undefined;
...
export const getEducationByIdService = async (param: string) => {
  const id = param;
...
export const upsertEducationService = async (params: Education) => {
  const id = params.id ?? "";
...
export const createBulkEducationService = async (params: Education[]) => {
...
export const deleteEducationByIdService = async (param: string) => {
  const id = param;
